[![Build Status](https://dev.azure.com/hannakujawska/PythonPipeline/_apis/build/status/hanolda.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/hannakujawska/PythonPipeline/_build/latest?definitionId=1&branchName=master)
